...
// console.log(aniket_testnet)

// gg bhai this works nicely noice damn bro

// const config={
//     networkId:"testnet",
//     keyStore:aniket_testnet,
//     nodeUrl: "https://rpc.testnet.near.org",
//     walletUrl: "https://wallet.testnet.near.org",
//     helperUrl: "https://helper.testnet.near.org",
//     explorerUrl: "https://explorer.testnet.near.org",
...
const client_testnet = KeyPair.fromString(process.env.client_testnet)
    ...
    // var get_request_base64=Buffer.from(get_request).toString("base64")

    // console.log(get_request_base64);
